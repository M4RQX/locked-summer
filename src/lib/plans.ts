...
export const PLANS: DayPlan[] = [
  {
    ...
    exercises: [
      ...
      { name: 'Supino inclinado (halteres)', sets: 3, reps: '8-12' },
  ...
  },
  {
    ...
    exercises: [
      { name: 'Puxada na polia alta (frente)', sets: 4, reps: '8-12' },
      { name: 'Remada com barra ou máquina', sets: 3, reps: '8-12' },
      { name: 'Remada unilateral haltere', sets: 3, reps: '10-12' },
      { name: 'Rosca direta (barra)', sets: 3, reps: '8-12' },
      { name: 'Rosca martelo', sets: 3, reps: '10-12' },
      { name: 'Rosca inversa', sets: 3, reps: '10-12' },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: 'Peso morto romeno (RDL)', sets: 3, reps: '8-12' },
      { name: 'Extensão de pernas', sets: 3, reps: '12-15' },
      { name: 'Desenvolvimento militar (halteres)', sets: 3, reps: '8-12' },
